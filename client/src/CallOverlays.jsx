...
const styles = {
  ...
  callCard: { background: "linear-gradient(135deg, #0D0D1A 0%, #12122A 100%)", padding: "20px 16px", borderRadius: "24px", border: "1px solid rgba(124,58,237,0.25)", color: "#fff", textAlign: "center", width: "min(94vw, 480px)", boxShadow: "0 20px 40px rgba(0,0,0,0.35)" },
  ...
  videoWrapper: { position: "relative", width: "min(100%, 280px)", height: "210px", backgroundColor: "#12122A", borderRadius: "12px", overflow: "hidden", border: "1px solid #2A2A4A", boxShadow: "inset 0 1px 0 rgba(255,255,255,0.04)" },
  ...
  controls: { display: "flex", gap: "10px", justifyContent: "center", marginTop: "20px", flexWrap: "wrap" },
